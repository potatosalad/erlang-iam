...
defimpl Inspect, for: [:iam_assert, :iam_bitset, :iam_claims, :iam_engine, :iam_params, :iam_set] do
  defdelegate inspect(struct, opts), to: IAM.Inspect
end
